...
|usePlaceholder|boolean: default = true|allows suppression of use of default or custom placeholder. Placeholders shows messages to the user while user components are fetched, and report errors|
|[_**OBJECTS**_]|
