...
|placeholder|sparse React component for the cell to load while waiting for the intended cell component|optional (replaces default placeholder). parameters are index, listsize, message, error. Arguments set by system|
