...
Notes: cache management functions operate on indexes and items in the cache, and ignores indexes and items that are not in the cache. This is a sparse cache, and indexes in the cache are not guaranteed to be contiguous.
