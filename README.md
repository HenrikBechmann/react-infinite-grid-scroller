...
|startingListRange|two part array [lowindex, highindex], or null for empty list|lowindex must be <= highindex; both can be positive or negative integers. `null` instead of array sets listSize to 0 in the absence of startingListSize|
