...
|usePlaceholder|boolean: default = true|allows suppression of use of placeholder, which shows a message to the user while user component is fetched, and reports errors|
|[_**OBJECTS**_]|
